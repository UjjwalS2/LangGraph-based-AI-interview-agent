...
Mirrors the node pipeline and benchmark numbers documented in the README
(cache hit p50 ~1.8ms, Flash p50 ~1.48s, Pro-escalated p50 ~4.9s,
~45.9% blended hit rate, <0.72 confidence gate) so the UI feels
